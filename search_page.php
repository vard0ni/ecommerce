...
<section class="search-form">
    ...
    <h1 class="title">Поиск картины</h1>

    <form action="" method="POST">
        <input type="text" class="box" placeholder="Введите название картины" name="search_box">
        <input type="submit" class="btn" value="Найти" name="search_btn">
    </form>
</section>
