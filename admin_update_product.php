    ...
    if(mysqli_num_rows($select_products) > 0){
        while($fetch_products = mysqli_fetch_assoc($select_products)){
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="text" class="box" value="<?php echo $fetch_products['name']; ?>" required placeholder="Обновить название товара" name="name">
                ...
                <textarea name="details" class="box" required placeholder="Обновить описание товара" cols="30" rows="10"><?php echo $fetch_products['details']; ?></textarea>
